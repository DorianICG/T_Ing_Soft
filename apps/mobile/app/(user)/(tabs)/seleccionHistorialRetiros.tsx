...
export default function SeleccionHistorialRetirosScreen() {
  ...
  return (
    <GlobalBackground>
      <View className="flex-1 justify-center items-center px-5 max-w-[400px] mx-auto w-full">
        ...
        <Text className="text-lg text-gray-600">¿De que alumno desea ver el historial de retiros?</Text>
            ...
            <ScrollView contentContainerClassName="space-y-4">
              {students.length > 0 && (
                <SelectOptionButton
                  ...
                  sublabel="Ver historial combinado"
                  isSelected={selectedPersonId === 0}
                  onPress={() => setSelectedPersonId(0)}
                />
              )}
